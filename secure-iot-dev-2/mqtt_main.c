...
char *cmd_connect[] = {"","mqtt","connect","mqtts://ec2-43-201-83-207.ap-northeast-2.compute.amazonaws.com","8883","iot-dev-2",""};
//char *cmd_connect[] = {"","mqtt","connect","mqtts://asepmas.myislab.com","8883","asep","09874321"};

char *cmd_publish_ec2[] = {"","mqtt","publish","/ec2/h1/r1/pir",""};
char *cmd_publish_aws[] = {"","mqtt","publish","/aws/h1/r1/pir",""};

static char **cmd_publish = cmd_publish_aws;
...
int mqtt_main(int argc, char *argv[])
{
	...
	while(1){
		printf("Secure MQTT Application - PIR\n");
