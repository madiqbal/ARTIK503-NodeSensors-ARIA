...
static char akc_uri[URI_MAX_LEN] = "coaps://ec2-52-78-51-87.ap-northeast-2.compute.amazonaws.com:5684";
//static char akc_uri[URI_MAX_LEN] = "coaps://asepmas.myislab.com:5684";
static char akc_device_id[UUID_MAX_LEN] = "iot-dev-2";
static char akc_device_token[UUID_MAX_LEN] = "09874321";
...
unsigned char crt_file[] =
	"-----BEGIN CERTIFICATE-----\r\n"
	"MIIB6DCCAY4CBFy8ICwwCgYIKoZIzj0EAwIwbjELMAkGA1UEBhMCS1IxDjAMBgNV\r\n"
	"BAgMBUJ1c2FuMQ4wDAYDVQQHDAVCdXNhbjEOMAwGA1UECgwFSVNMQUIxETAPBgNV\r\n"
	"BAsMCEhhcmR3YXJlMRwwGgYDVQQDDBNhc2VwbWFzLm15aXNsYWIuY29tMB4XDTE4\r\n"
	"MDQyMTA3NDc1NloXDTIwMDQyMDA3NDc1NlowgY4xCzAJBgNVBAYTAktSMQ4wDAYD\r\n"
	...
	"YXJkd2FyZTESMBAGA1UEAwwJaW90LWRldi0yMFkwEwYHKoZIzj0CAQYIKoZIzj0D\r\n"
	"AQcDQgAEUOIBdE+Yc5sSn535RaHeeH01B3o2RGpk4N33QR1YhNQzGjkotR8XGHwO\r\n"
	"T23cFXg6wMXVpA/psbkDTsCUaZNTEDAKBggqhkjOPQQDAgNIADBFAiBaz3iXfZNE\r\n"
	"1R8Y0jQ7JiRVLoHYBPY8g262XujQ3RXzYAIhAMDF2RanPdUdLuXSf2L37TzrMLTs\r\n"
	"T7RKSPpVzBllXV8A\r\n"
	"-----END CERTIFICATE-----\r\n";

unsigned char key_file[] =
	"-----BEGIN PRIVATE KEY-----\r\n"
	"MIGTAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBHkwdwIBAQQglmlCBuY4gK7Zvn8o\r\n"
	"25O170TVyHsugQMuBXeaMwH7MVegCgYIKoZIzj0DAQehRANCAARQ4gF0T5hzmxKf\r\n"
	"nflFod54fTUHejZEamTg3fdBHViE1DMaOSi1HxcYfA5PbdwVeDrAxdWkD+mxuQNO\r\n"
	"wJRpk1MQ\r\n"
	"-----END PRIVATE KEY-----\r\n";
