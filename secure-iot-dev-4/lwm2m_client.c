...
static char akc_uri[URI_MAX_LEN] = "coaps://ec2-54-234-178-65.compute-1.amazonaws.com:5684";
//static char akc_uri[URI_MAX_LEN] = "coaps://asepmas.myislab.com:5684";
static char akc_device_id[UUID_MAX_LEN] = "iot-dev-4";
static char akc_device_token[UUID_MAX_LEN] = "09874324";
...
unsigned char crt_file[] =
	"-----BEGIN CERTIFICATE-----\r\n"
	"MIIB5zCCAY4CBFy8ISEwCgYIKoZIzj0EAwIwbjELMAkGA1UEBhMCS1IxDjAMBgNV\r\n"
	"BAgMBUJ1c2FuMQ4wDAYDVQQHDAVCdXNhbjEOMAwGA1UECgwFSVNMQUIxETAPBgNV\r\n"
	"BAsMCEhhcmR3YXJlMRwwGgYDVQQDDBNhc2VwbWFzLm15aXNsYWIuY29tMB4XDTE4\r\n"
	"MDQyMTA3NTIwMVoXDTIwMDQyMDA3NTIwMVowgY4xCzAJBgNVBAYTAktSMQ4wDAYD\r\n"
	...
	"YXJkd2FyZTESMBAGA1UEAwwJaW90LWRldi00MFkwEwYHKoZIzj0CAQYIKoZIzj0D\r\n"
	"AQcDQgAER45dakdb1UXtFK/rRE55v12caTlP0iKCDy9sd7nBZmumqEp2ZBVqDVVJ\r\n"
	"yaBswMwlW4SI3UbRYOJzc9P0011R7zAKBggqhkjOPQQDAgNHADBEAiBgi5xOkL04\r\n"
	"2QPdB4G8KkrMd3u1I6WE6wtaey7zuMRdiwIgHn4Fq/J5CKVj7hI73gk7jGZLxUoa\r\n"
	"BQfiZh2WDviNj7Q=\r\n"
	"-----END CERTIFICATE-----\r\n";

unsigned char key_file[] =
	"-----BEGIN PRIVATE KEY-----\r\n"
	"MIGTAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBHkwdwIBAQQg3xz3h+c+n/s/bsV2\r\n"
	"4W1PQi063/9Vo/PCIn3mlrck/rigCgYIKoZIzj0DAQehRANCAARHjl1qR1vVRe0U\r\n"
	"r+tETnm/XZxpOU/SIoIPL2x3ucFma6aoSnZkFWoNVUnJoGzAzCVbhIjdRtFg4nNz\r\n"
	"0/TTXVHv\r\n"
	"-----END PRIVATE KEY-----\r\n";
