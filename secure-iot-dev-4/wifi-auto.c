...
//#define WIFI_SSID "iptime_ku"
//#define WIFI_PASSPHRASE "09874321"// "123987456"//

#define WIFI_SSID "ISLAB_DEMO_IOT"
#define WIFI_PASSPHRASE "l1954tp!"
...
void setup_time(void){
	...
	time_modu->set_time(date, ARTIK_TIME_GMT8);
}
